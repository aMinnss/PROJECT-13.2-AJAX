...
// const errorP = document.getElementById("6taskError"); 

// const xhr = new XMLHttpRequest();

// xhr.open("GET", "https://jsonplaceholder.typicode.com/pasasosts", true);
...
//     console.log(data)
//   } else {
//     console.error( "Ошибка 5 задания: " + xhr.status)
//   }
// }

// xhr.onerror = function() {
//   errorP.textContent = "Сетевая ошибка";
// }
...
xhr.onload = function() {
  if(xhr.status === 200) {
    ...
    console.error("Ошибка 6 задания: " + xhr.status)
  }
}
